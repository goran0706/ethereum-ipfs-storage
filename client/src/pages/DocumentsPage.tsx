...
const DocumentsPage = () => {
  ...
  const { data, error, isError, isLoading } = useFileRead<IFileInfo[]>('getDocuments')
...
const EnhancedComponent = requireConnect(DocumentsPage)
